...
from collections import deque  # Importa deque para usarlo como una cola LIFO.
...
class PuzzleDeslizante:
    ...
    # Resuelve el puzzle utilizando búsqueda en profundidad (DFS) con un límite de profundidad.
    def resolver(self):
        LIMITE_PROFUNDIDAD = 52  # Límite de profundidad para la búsqueda.
        frontera = set()  # Conjunto para almacenar los estados visitados.
        pila = [Nodo(self.estado_inicial)]  # Pila inicializada con el nodo raíz.
        contador_estados_visitados = 0  # Contador de estados visitados.

        while pila:  # Mientras haya nodos en la pila.
            nodo_actual = pila.pop()  # Extrae el nodo actual de la pila (LIFO).
            contador_estados_visitados += 1  # Incrementa el contador de estados visitados.

            # Si la profundidad del nodo excede el límite, lo descarta.
            ...
            for movimiento in self.movimientos:
                ...
                if nuevo_estado and tuple(map(tuple, nuevo_estado)) not in frontera:
                    ...
                    pila.append(nuevo_nodo)  # Agrega el nuevo nodo a la pila.
